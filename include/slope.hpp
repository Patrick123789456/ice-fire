...
public:
    ...
    bool IsOnSlope(const std::shared_ptr<Util::GameObject>& player, float footOffset, float tolerance) const;
    void SnapToSlope(const std::shared_ptr<Util::GameObject>& player, float footOffset) const;
